      ...
      builder: (context) => AlertDialog(
            ...
            children: [
              Text("⚠️ 필수 확인",
                  style: TextStyle(
                      ...
                      fontSize: 12)),
              SizedBox(height: 5),
              Text("• 어플 종료 시 문자 발송 안됩니다.",
                  style: TextStyle(
                      fontSize: 11,
                      color: Colors.red,
                      fontWeight: FontWeight.bold)),
              Text("• 안전감시모드 스위치 껏다 다시켜주세요.",
                  style: TextStyle(
                      fontSize: 11,
                      color: Colors.blue,
                      fontWeight: FontWeight.bold)),
        ...
        actions: [
          TextButton(
              ...
              child: const Text("확인했습니다", style: TextStyle(fontSize: 12))),
        ],
      ),
    );
  }
      ...
      child: SafeArea(
        child: Column(
          children: [
              ...
              child: ScaleTransition(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Colors.white,
                    border: _isPressed
                        ? Border.all(color: const Color(0xFFFFD1DC), width: 6)
                        : null,
                    boxShadow: _isPressed
                        ? [
                            BoxShadow(
                                color: const Color(0xFFFFD1DC).withOpacity(0.8),
                                blurRadius: 15,
                                spreadRadius: 3)
                          ]
                        : [
                  ...
                  child: ClipOval(
                    child: Image.asset(
                      ...
                      fit: BoxFit.cover,
                      errorBuilder: (c, e, s) =>
                          const Icon(Icons.face, size: 90, color: Colors.orange),
                    ),
                  ),
                ),
              ),
            ...
            const Spacer(flex: 3),
            const Text("미응답 시 설정된 연락처로 위치 정보가 전송됩니다.",
...
class HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("안심 활동 기록", style: TextStyle(fontSize: 15)),
...
class _SettingScreenState extends State<SettingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("설정 및 가이드", style: TextStyle(fontSize: 15)),
          backgroundColor: Colors.transparent),
                        ...
                        onChanged: (v) async {
                          ...
                          if (v) {
                            await FlutterForegroundTask.startService(
                                notificationTitle: "1인가구 안심 지키미 작동 중",
                                notificationText: "실시간 감시가 활성화되었습니다.",
                  ...
                  trailing: IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await prefs.setString(
                            'contacts_list', json.encode(_contacts));
                      }),
                )),
            Padding(
